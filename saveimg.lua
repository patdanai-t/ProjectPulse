...
local DEFAULT = {
    Background = Color3.fromRGB(19, 24, 33),
    Surface = Color3.fromRGB(25, 31, 42),
    SurfaceAlt = Color3.fromRGB(31, 39, 53),
    Sidebar = Color3.fromRGB(22, 27, 37),
    Border = Color3.fromRGB(63, 79, 102),
    Text = Color3.fromRGB(236, 242, 255),
    TextMuted = Color3.fromRGB(148, 165, 189),
    Accent = Color3.fromRGB(72, 138, 255),
    AccentDark = Color3.fromRGB(36, 82, 170),
    Success = Color3.fromRGB(86, 194, 255),
    Warning = Color3.fromRGB(255, 204, 110),
...
function Window:CreateTab(name, icon)
    ...
    function tab:CreateSection(sectionName)
        ...
        function section:CreateImage(labelText, imageSource, options)
            options = options or {}
            local component = baseElement("Image", labelText or "Image", nil, imageSource)
            ...
            local image = Utility.Create("ImageLabel", {
                BackgroundColor3 = theme:Get("Surface"),
                BorderSizePixel = 0,
                Position = UDim2.fromOffset(0, (options.Description and options.Description ~= "") and 44 or 28),
                Size = UDim2.new(1, 0, 0, options.Height or 104),
        ...
        function section:CreateBanner(labelText, imageSource, options)
            options = options or {}
            local component = baseElement("Banner", labelText or "Banner", nil, imageSource)
            component.Frame.Size = UDim2.new(1, 0, 0, 186)
            ...
            Utility.Create("TextLabel", {
                ...
                Position = UDim2.fromOffset(0, 22),
                Size = UDim2.new(1, 0, 0, 14),
                Text = options.Label or labelText or "Banner",
                TextColor3 = theme:Get("TextMuted"),
                TextSize = 11,
                TextXAlignment = Enum.TextXAlignment.Left,
                Parent = component.Frame,
            ...
            Utility.Create("TextLabel", {
                ...
                Text = options.Title or "Banner Title",
                TextColor3 = theme:Get("Text"),
                TextSize = 12,
                TextXAlignment = Enum.TextXAlignment.Left,
                Parent = card,
    ...
    function tab:Image(labelText, imageSource, options)
        local section = self.Sections[1] or self:CreateSection("General")
        return section:CreateImage(labelText or "Image", imageSource or "", options or {})
    end

    function tab:Banner(labelText, imageSource, options)
        local section = self.Sections[1] or self:CreateSection("General")
        return section:CreateBanner(labelText or "Banner", imageSource or "", options or {})
    end
